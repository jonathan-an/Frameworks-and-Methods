# 1. Compute 12345678 multiplied by 87654321
12345678 * 87654321


# 2.  What is the square root of 111222333444555666.
sqrt(111222333444555666)


# 3.  What is the log to base 10 of 111222333444555666.
log10(111222333444555666)
log(x = 111222333444555666, base = 10)


# 4.  How many IDs does the following code generate? 
paste('ID',seq(from=10,to=100,by=10))
str(paste('ID',seq(from=10,to=100,by=10)))


# 5. How many observations does the following code generate? 
...
# 9. What class will the following statement return? 45 == 56
45 == 56
class(45 == 56)


# 10. What class will the following statement return? as.numeric(F)
as.numeric(F)
class(as.numeric(F))
